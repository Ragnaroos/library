...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" ><a href="staff_cirin_return.html">去归还</a></li>
            <li role="presentation" class="active"><a href="staff_cirin_return_waiting.html">审核中</a></li>
        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${books}" var="books" varStatus="status">
                <tr>
                    ...
                    <td>
                        <fmt:formatDate value="${bookCirculates[status.index].return_time}" pattern="yyyy-MM-dd" />
                    </td>
                    <td>
                        <c:choose>
                            <c:when test="${bookCirculates[status.index].cir_state == 'waitReturnCheck'}">
                                <span style="color: red;"><strong>归还审核中</strong></span>
                            </c:when>
                        </c:choose>
                    </td>
