...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${books}" var="books">
                <tr>
                    ...
                    <td><a href="admin_all_book_info.html?book_id=<c:out value="${books.book_id}"></c:out>"><button type="button" class="btn btn-primary btn-xs">详情</button></a></td>
                    <td><a href="admin_all_book_update.html?book_id=<c:out value="${books.book_id}"></c:out>"><button type="button" class="btn btn-info btn-xs">编辑</button></a></td>
                    <td><a href="admin_all_book_deleteone.html?book_id=<c:out value="${books.book_id}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        ...
        <div class="form-group">
            <a href="admin_all_book.html"><button type="button" class="btn btn-info btn-xs">返回</button></a>
        </div>
    </div>
</div>
