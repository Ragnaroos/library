...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation"><a href="reader_book_borrow.html">去归还</a></li>
            <li role="presentation" class="active"><a href="reader_book_borrow_waiting.html">待审核</a></li>
        </ul>
        <table class="table table-hover" >
            ...
            <c:forEach items="${books}" var="books" varStatus="status">
                <tr>
                    ...
                    <td>
                                <span style="color: red;"><strong>借阅待审核</strong></span>
                    </td>
