...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="reader_book_return.html">去归还</a></li>
            <li role="presentation"><a href="reader_book_return_waiting.html">待审核</a></li>
                ...
                <table class="table table-hover" >
                    ...
                    <c:forEach items="${books}" var="books" varStatus="status">
                        <tr>
                            ...
                            <td>
                                <span style="color: green;"><strong>可归还</strong></span>
                            </td>

                            <td>
                                <a href="reader_book_return_do.html?book_id=${books.book_id}">
                                    <button type="button" class="btn btn-info btn-xs" ${bookBorrows[status.index].comment == 'waitingCheck' ? 'disabled' : ''}>归还</button>
                                </a>
                            </td>
                        </tr>
                    </c:forEach>
