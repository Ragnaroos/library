...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="staff_cirin_apply.html">去流入</a></li>
            <li role="presentation"><a href=staff_cirin_apply_waiting.html">待审核</a></li>
        </ul>
        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${books}" var="books" varStatus="status">
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${bookCirculates[status.index].cir_state == 'free'}">
                                <span style="color: green;"><strong>可流入</strong></span>
                            </c:when>
                        </c:choose>
                    </td>

                    <td>
                        <a href="staff_cirin_apply_do.html?book_id=${books.book_id}">
                            <button type="button" class="btn btn-info btn-xs" ${bookCirculates[status.index].cir_state != 'free' ? 'disabled' : ''}>流入</button>
                        </a>
                    </td>
                </tr>
            </c:forEach>
