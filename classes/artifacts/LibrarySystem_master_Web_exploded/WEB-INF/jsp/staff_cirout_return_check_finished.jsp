...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" ><a href="staff_cirout_return_check.html">待审核</a></li>
            <li role="presentation" class="active"><a href="staff_cirout_return_check_finished.html">已结束</a></li>
        </ul>
        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${books}" var="books" varStatus="status">
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${bookCirculates[status.index].comment == 'finished'}">
                                <span style="color: grey;"><strong>已结束</strong></span>
                            </c:when>
                        </c:choose>
                    </td>
