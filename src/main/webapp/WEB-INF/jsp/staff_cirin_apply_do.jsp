...
<div class="col-xs-6 col-md-offset-3" style="padding-top: 100px;position: relative">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="staff_cirin_apply_submit.html?book_id=${thisbook.book_id}" method="post" id="staff_cirin_apply_submit" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="belongto">流入理由</label>
                    <input type="text" class="form-control" name="cir_reason" id="brw_reason" required>
                </div>

                <div class="form-group">
                    <input type="submit" value="确定" class="btn btn-success btn-sm" class="text-left">
                    <a href="staff_cirin_apply.html" class="btn btn-info btn-sm">返回</a>
                </div>
