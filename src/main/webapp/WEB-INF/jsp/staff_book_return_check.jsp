...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="staff_book_return_check.html">待审核</a></li>
            <li role="presentation"><a href="staff_book_return_finished.html">已结束</a></li>
        </ul>
        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${books}" var="books" varStatus="status">
                <tr>
                    ...
                    <td><a href="staff_book_return_check_agree.html?book_id=<c:out value="${books.book_id}"></c:out>"><button type="button" class="btn btn-success btn-xs">通过</button></a></td>
                    <td><a href="staff_book_return_check_disagree.html?book_id=<c:out value="${books.book_id}"></c:out>"><button type="button" class="btn btn-danger btn-xs">拒绝</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
