...
<div class="panel panel-default" id="login">
  ...
  <div class="panel-body">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="id" placeholder="请输入工号">
    </div>
    <div class="form-group">
      <label for="passwd">密码</label>
      <input type="password" class="form-control" id="passwd" placeholder="请输入密码，默认为工号后6位">
    </div>
    ...
    <div class="text-left" style="margin-bottom: 10px;">
      <a href="admin_login.html" style="margin-right: 15px;">系统管理员登录</a>
      <a href="login.html">读者登录</a>
    </div>
