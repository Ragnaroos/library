...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation"><a href="staff_book_borrow_check.html">待审核</a></li>
            <li role="presentation" class="active"><a href="staff_book_borrow_check_ing.html">借阅中</a></li>
        </ul>
        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${books}" var="books" varStatus="status">
                <tr>
                    ...
                    <td>
                        <span style="color: green;"><strong>借阅中</strong></span>
                    </td>
