...
<div class="panel panel-default" style="position:relative;top: 80px;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="reader_book_borrow.html">去借阅</a></li>
            <li role="presentation"><a href="reader_book_borrow_waiting.html">待审核</a></li>
        </ul>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${bookBorrows[status.index].isbrwed == 'no'}">
                                <span style="color: green;"><strong>可借</strong></span>
                            </c:when>
